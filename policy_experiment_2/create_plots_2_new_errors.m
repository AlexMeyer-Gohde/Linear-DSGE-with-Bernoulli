...
combined_results_old=combined_results;
load('Combined_Policy_Run_fill_2_errors_2.mat')
combined_results_old(2:8,3:5,:)=combined_results(2:8,3:5,:);
combined_results_old(9,3:5,:)=combined_results(13,3:5,:);
combined_results_old(10:11,3:5,:)=combined_results(10:11,3:5,:);
combined_results_old(12,3:5,:)=combined_results(15,3:5,:);
combined_results_old(13:14,3:5,:)=combined_results([14 16],3:5,:);
